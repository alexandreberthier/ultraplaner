...
/** Nearby (Umgebung) defaults — sparse on purpose so cities stay readable. */
export const NEARBY_DEFAULT_POI_CATEGORIES: PoiCategory[] = ['fuel', 'supermarket']
...
export const NEARBY_DEFAULT_POI_RADIUS_M = 2000
