...
export const OSM_FILTERS: OsmFilter[] = [
  ...
  { key: 'shop', value: 'kiosk', subType: 'Kiosk', category: 'kiosk' },
  { key: 'amenity', value: 'vending_machine', subType: 'Automat', category: 'vending' },
  { key: 'amenity', value: 'toilets', subType: 'Toilette', category: 'toilets' },
  ...
  { key: 'tourism', value: 'alpine_hut', subType: 'Berghütte', category: 'alpine_hut' },
  { key: 'tourism', value: 'camp_site', subType: 'Campingplatz', category: 'campsite' },
  { key: 'amenity', value: 'shelter', subType: 'Unterstand', category: 'shelter' },
